...
A web app that lets users view and leave comments on the latest news scraped from NPR.

### Steps

1. Create a GitHub repo for this assignment and clone it to the computer. Any name will do -- just make sure it's related to this project in some fashion.
